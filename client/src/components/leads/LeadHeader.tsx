        ...
        <div className="relative" ref={profileRef}>
          ...
          {isProfileOpen && (
            <div className="absolute right-0 top-full mt-2 w-56 bg-white/90 backdrop-blur-xl rounded-2xl border border-slate-200/80 shadow-xl py-2 z-50 animate-scaleUp">
              ...
              <button onClick={() => { onNavigate('/lead/settings'); setIsProfileOpen(false); }} className="w-full flex items-center gap-3 px-4 py-2.5 text-xs font-medium text-slate-600 hover:bg-slate-50 transition-colors cursor-pointer">
