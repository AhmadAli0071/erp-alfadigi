  ...
  return (
    <div className="space-y-6" id="settings-panel-general">
      <div className="border-b border-white/5 pb-4">
        <h3 className="text-base font-semibold text-white">General System Configuration</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full bg-[#14151e] border border-white/10 rounded-xl px-3.5 py-2.5 text-xs text-white placeholder:text-slate-500 focus:outline-none focus:border-indigo-500"
            id="general-system-name"
          />
          <p className="text-[11px] text-slate-500">The branded portal title shown across dashboard headers.</p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          />
          <p className="text-[11px] text-slate-500">Legal entity name utilized on generated exports and payslips.</p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[11px] text-slate-500">Reference timezone for biometric time clocks and daily cutoffs.</p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[11px] text-slate-500">Standard display format for calendar and report grids.</p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[11px] text-slate-500">Biometric time presentation style across rosters.</p>
        </div>
      </div>
    </div>
  );
