...
export const HRPlaceholderView: React.FC<HRPlaceholderViewProps> = ({
        ...
        <div className="flex items-center justify-between pb-3 border-b border-white/5">
          <div className="flex items-center gap-3">
            <button
              ...
              className="p-2 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-slate-300 hover:text-white transition-colors flex items-center gap-2 text-xs font-semibold cursor-pointer"
            >
            ...
            <div>
              <h2 className="text-lg font-bold text-white tracking-tight">Today's Attendance Records</h2>
              <p className="text-xs text-slate-400">Detailed shift logs, overnight punches, and department filters</p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="p-8 sm:p-12 rounded-2xl bg-[#121318] border border-white/10 text-center max-w-2xl mx-auto shadow-xl my-8 space-y-6 animate-fadeIn">
      ...
      <div className="space-y-2">
        <span className="inline-block text-[10px] font-mono font-bold px-3 py-0.5 rounded-full bg-indigo-500/10 text-indigo-300 border border-indigo-500/20 uppercase tracking-wider">
          {details.tag}
        </span>
      ...
      <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/5 text-left text-xs text-slate-400 max-w-md mx-auto space-y-1 font-mono">
        ...
        <div className="flex justify-between">
          ...
          <span className="text-slate-300">Dedicated Module View</span>
        </div>
      </div>
